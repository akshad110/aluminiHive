import { isRazorpayConfigured, shouldUseMockPayments } from "./config/razorpay";
import express from "express";
import cors from "cors";
import multer from "multer";
import { handleDemo } from "./routes/demo";
import { generateStreamToken } from "./routes/stream";
...
export async function createServer() {
  ...
  // Stream video token (server-side only — never expose API secret to client)
  ...
  app.post("/api/batches/:batchId/chat/messages", sendBatchMessage);
