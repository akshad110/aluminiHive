...
export default function Index() {
  ...
  return (
    <>
      {/* Hero Section */}
      <section className="relative min-h-[92dvh] overflow-hidden bg-white w-full">
        ...
        <div className="container relative z-10 mx-auto flex min-h-[92dvh] flex-col items-center justify-center py-12 sm:py-16 text-center px-4">
          <Reveal>
            <h1
              style={{ fontFamily: "Montserrat" }}
              className="max-w-4xl text-3xl sm:text-4xl font-extrabold leading-tight tracking-tight text-primary md:text-6xl"
            >
              Welcome to AlumniHive – Connecting Generations.
            </h1>
          </Reveal>
          <Reveal delay={0.1}>
            <p className="mt-4 max-w-3xl text-balance text-base sm:text-lg text-muted-foreground md:text-xl">
              Mentorship, Jobs, Networking, and Alumni Engagement in One Place.
            </p>
          </Reveal>
          <Reveal delay={0.2}>
            <div className="mt-6 sm:mt-8 flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-4">
              <Button asChild size="lg" className="bg-brand-orange hover:bg-brand-orange/90 shadow-lg shadow-brand-orange/20 w-full sm:w-auto">
      ...
      <section className="w-full bg-white overflow-hidden">
        <div className="container mx-auto py-8 sm:py-10 md:py-16 px-4">
        <Reveal>
          <div className="mb-4 sm:mb-6 flex flex-col sm:flex-row sm:items-end justify-between gap-2">
            <h2 className="text-xl sm:text-2xl font-semibold text-primary md:text-3xl" style={{fontFamily:'Montserrat'}}>Alumni Highlights</h2>
            <p className="text-xs sm:text-sm text-muted-foreground">Stories from our vibrant community</p>
          </div>
        </Reveal>
      ...
      {/* About */}
      <section id="about" className="scroll-mt-24 bg-white py-16 w-full">
      ...
      {/* Student Benefits */}
      <section id="benefits" className="scroll-mt-24 bg-muted/30 py-16 w-full">
        <div className="container mx-auto px-4">
          <div className="grid items-center gap-8 md:grid-cols-2">
          <Reveal>
            <div className="relative">
      ...
      {/* Alumni */}
      <section id="alumni" className="scroll-mt-24 bg-muted/30 py-16 w-full">
        <div className="container mx-auto px-4">
      ...
      {/* Mentorship */}
      <section id="mentorship" className="scroll-mt-24 bg-white py-16 w-full">
        <div className="container mx-auto px-4">
          <div className="grid items-center gap-8 md:grid-cols-2">
          <Reveal>
